...
class RestaurantsPresenter {
	...
	func obtainRestorans() {
		...
		guard let url = URL(string: "http://0aa8c248f5af.ngrok.io/main_map_restaurants_api") else {
			return
		}
	...
	func obtainSearch(searchText: String) {
		...
		guard var components = URLComponents(string: "http://0aa8c248f5af.ngrok.io/search_results_view_api") else {
			return
		}
